...
//He declared a push to  the existing data but I didnt
...
//Write  function that returns the total number of students present
const students =[
  {id:1, present:true},
  {id:2, present:false},
  {id:3, present:false},
...
function studentsPresent(students){
  ...
  //For any iteration(step) if student is present then increase total present by 1;
